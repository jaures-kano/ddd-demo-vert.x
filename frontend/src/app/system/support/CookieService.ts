...
export class CookieService {
	...
	/**
	 * Gets the unencoded version of an encoded components of a Uniform Resource Identifier (URI).
	 *
	 * @param encodedURIComponent A value representing an encoded URI components.
	 *
	 * @returns The unencoded version of an encoded components of a Uniform Resource Identifier (URI).
	 *
	 * @author: Stepan Suvorov
	 * @since: 1.0.0
	 */
